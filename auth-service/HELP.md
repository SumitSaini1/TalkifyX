...
* The original package name 'com.talkifyx.auth-service' is invalid and this project uses 'com.talkifyx.auth_service' instead.
...
* [OAuth2 Client](https://docs.spring.io/spring-boot/3.5.13/reference/web/spring-security.html#web.security.oauth2.client)
